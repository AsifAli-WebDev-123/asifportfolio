...
// Get all accordion headers and content elements
...
accordionHeaders.forEach(function (header, index) {
  header.addEventListener("click", function () {
    // Check if the clicked header is already active (expanded)
    ...
    // If the header was not active, expand the clicked section
    if (!isActive) {
      accordionContents[index].style.maxHeight = "max-content";
